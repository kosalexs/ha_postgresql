...
sed -i 's/\#listen_addresses = '\''localhost'\''/listen_addresses = '\''10.157.20.12'\''/g' /etc/postgresql/12/main/postgresql.conf
...
restapi:
    listen: 10.157.20.12:8008
    connect_address: 10.157.20.12:8008
...
postgresql:
    listen: 10.157.20.12:5432
    connect_address: 10.157.20.12:5432
